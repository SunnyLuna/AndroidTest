...
import com.github.barteksc.pdfviewer.listener.OnLocationListener;
...
public class PDFView extends RelativeLayout {
	...
	public void setPositionOffset(float progress, boolean moveHandle) {
		if (swipeVertical) {
			moveTo(currentXOffset, (-pdfFile.getDocLen(zoom) + getHeight()) * progress,
					moveHandle);
		} else {
	...
	/**
	 * Use stream as the pdf source. Stream will be written to bytearray, because native code
	 * does not support Java Streams
	 */
	...
	public class Configurator {
		...
		public Configurator onLocation(OnLocationListener onLocationListener) {
		...
		public void load() {
			...
			PDFView.this.callbacks.setLocation(onLocationListener);
