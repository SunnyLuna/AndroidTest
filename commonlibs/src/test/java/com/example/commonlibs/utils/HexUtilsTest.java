...
public class HexUtilsTest {
	...
	public void toHexString1() {
		byte[] bytes = new byte[]{0x00, (byte) 0x01, (byte) 0xA2, (byte) 0xB3, (byte) 0xC4,
                (byte) 0xD5, (byte) 0xE6, (byte) 0xF7};
	...
	public void toHexString2() {
		byte[] bytes = new byte[]{0x00, (byte) 0x01, (byte) 0xA2, (byte) 0xB3, (byte) 0xC4,
                (byte) 0xD5, (byte) 0xE6, (byte) 0xF7};
		assertEquals("0001A2B3C4D5E6F7", HexUtils.toHexString(bytes, 0, bytes.length, true));
	}
