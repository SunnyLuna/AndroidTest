...
public class MQTTService extends Service {
	...
	private static String myTopic = "decard_hbs_queue";  //要订阅的主题
	private static String topic = "decard_hbs_topic";  //要订阅的主题
	...
	private void init() {
		...
		// 服务器地址（协议+地址+端口号）
		mMqttClient = new MqttAndroidClient(MQTTApplication.instance, host, clientId);
		// 设置MQTT监听并且接受消息
...
//                mMqttClient.subscribe(myTopic, 1);
		...
		public void onFailure(IMqttToken arg0, Throwable arg1) {
			Log.d(TAG, "onFailure: 连接失败：" + arg0.getException().getMessage() + arg1.getMessage());
...
//                mMqttClient.publish(topic, msg.getBytes(), 1, false);
	...
	public void createNotification(String message) {
		PendingIntent pendingIntent = PendingIntent.getActivity(this, 1, new Intent(this,
				MQTTService.class), PendingIntent.FLAG_UPDATE_CURRENT);
