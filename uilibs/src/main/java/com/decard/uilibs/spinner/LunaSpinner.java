...
public class LunaSpinner extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public LunaSpinner(Context context) {
        super(context);
        init(null);
    }

    public LunaSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public LunaSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_OUTSIDE: {
                        ...
                        if (isTouchInsideViewBounds(x, y, mViewBounds, LunaSpinner.this)
                                && mPopup.isShowing()) {
                            return true;
                        }
