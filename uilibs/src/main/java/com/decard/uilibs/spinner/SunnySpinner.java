 ...
 *
 * @author ZJ
 * created at 2020/9/9 18:50
 */
public class SunnySpinner extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public SunnySpinner(Context context) {
        super(context);
        init(null);
    }

    public SunnySpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SunnySpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public Parcelable onSaveInstanceState() {
        Log.d("---ZJSpinner", "onSaveInstanceState");
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        Log.d("---ZJSpinner", "onRestoreInstanceState");
    ...
    private void init(AttributeSet attrs) {
        Log.d("---ZJSpinner", "init");
        Resources resources = getResources();
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.SunnySpinner);
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.dp_1_5);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setPadding(resources.getDimensionPixelSize(R.dimen.dp_3),
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_OUTSIDE: {
                        ...
                        if (isTouchInsideViewBounds(x, y, mViewBounds, SunnySpinner.this)
                                && mPopup.isShowing()) {
                            return true;
                        }
        ...
        int resId = typedArray.getColor(R.styleable.SunnySpinner_arrowTint, -1);
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        Log.d("---ZJSpinner", "onTouchEvent: " + event.getAction() + mPopup.isShowing());
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    textView.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.spinner_selector));
                }
