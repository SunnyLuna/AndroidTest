...
//			}
//		}, 500);
		Observable.interval(500, TimeUnit.MILLISECONDS).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Long>() {
			@Override
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.d(TAG, "onDraw:wifiLength " + wifiLength + "signalSize: " + signalSize +
				"signalRadius" +
				": " + signalRadius);
